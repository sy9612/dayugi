...
public interface FileService {
    ...
    public int saveFile(DiaryFile file) throws Exception;
    ...
    boolean deleteAllFile(int did) throws Exception;//해당 다이어리 관련 파일 전부 삭제
    boolean deleteFile(int fid) throws Exception;//해당 파일만 삭제
    boolean deleteUserFile(int uid) throws Exception;//사용자가 작성한 파일 전체 삭제
}
